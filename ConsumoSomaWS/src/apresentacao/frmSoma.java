...
import webServices.SomarWS;

/**
 *
 * @author Rever
 */
public class frmSoma extends javax.swing.JDialog
{

    /**
     * Creates new form frmSoma
     */
    public frmSoma(java.awt.Frame parent, boolean modal)
    {
        super(parent, modal);
        initComponents();
    }
    ...
    {//GEN-HEADEREND:event_btnCalcularActionPerformed
        lblResposta.setText(SomarWS.somar(txfPrimeiroNumero.getText(), 
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                frmSoma dialog = new frmSoma(new javax.swing.JFrame(), true);
